...
public class RepositoryListAdapter extends RecyclerView.Adapter<RepositoryListAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(RepositoryListAdapter.ViewHolder holder, final int position) {
        ...
        holder.repositoryBranch.setText(repositoryLists.get(position).getBranch());
        holder.repositoryFavorite.setText(repositoryLists.get(position).getFavorite());
        holder.repositoryUserName.setText(repositoryLists.get(position).getUserName());
