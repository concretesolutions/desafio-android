...
public class ListPullRequestActivityModule {
    ...
    static ListPullRequestViewModel providePullRequestViewModel(final Application application,
                                                                ...
                                                                final AppExecutors appExecutors) {//*, final AppExecutors appExecutors, final AppDatabase appDatabase, final SharedPreferencesUtil sharedPreferencesUtil*//*) {
        return new ListPullRequestViewModel(new ListRepository(iService, sharedPreference, application, appExecutors, appDatabase), application);
    }
}
