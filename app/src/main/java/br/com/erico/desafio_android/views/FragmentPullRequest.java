...
public class FragmentPullRequest extends Fragment {
    ...
    public FragmentPullRequest() {

    }

    public static FragmentPullRequest newInstance(String param1, String param2) {
        FragmentPullRequest fragment = new FragmentPullRequest();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_description_request, container, false);
    }
