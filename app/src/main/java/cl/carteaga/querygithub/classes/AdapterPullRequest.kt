...
class AdapterPullRequest(val data: List<PullRequest>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindView(pullRequest: PullRequest) {
            ...
            itemView.txtAuthorNamePullRequest.text = pullRequest.user.name
            ...
            itemView.setOnClickListener {
                itemView.context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse(pullRequest.urlPullRequest)))
            }
        }
    }
}